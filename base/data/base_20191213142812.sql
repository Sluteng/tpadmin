...
-- ----------------------------
INSERT INTO `tp_admin_user` (`id`,`account`,`realname`,`password`,`last_login_time`,`last_login_ip`,`login_count`,`email`,`mobile`,`remark`,`status`,`isdelete`,`create_time`,`update_time`) VALUES ('1','admin','超级管理员','e10adc3949ba59abbe56e057f20f883e','1576218036','127.0.0.1','19','tianpian0805@gmail.com','13121126169','我是超级管理员','1','0','1222907803','1451033528');
INSERT INTO `tp_admin_user` (`id`,`account`,`realname`,`password`,`last_login_time`,`last_login_ip`,`login_count`,`email`,`mobile`,`remark`,`status`,`isdelete`,`create_time`,`update_time`) VALUES ('2','demo','测试','e10adc3949ba59abbe56e057f20f883e','1574986166','127.0.0.1','0','','','','1','0','1476777133','1477399793');
...
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='网站日志';
-- ----------------------------
-- Records of tp_web_log_all
-- ----------------------------
INSERT INTO `tp_web_log_all` (`id`,`uid`,`ip`,`location`,`os`,`browser`,`url`,`module`,`controller`,`action`,`method`,`data`,`create_at`) VALUES ('1','1','127.0.0.1','本机地址 本机地址  ','Windows 10','Chrome(75.0.3770.100)','http://base.local/admin/web_log/index.html','admin','WebLog','index','GET','a:0:{}','1576218489');
INSERT INTO `tp_web_log_all` (`id`,`uid`,`ip`,`location`,`os`,`browser`,`url`,`module`,`controller`,`action`,`method`,`data`,`create_at`) VALUES ('2','1','127.0.0.1','本机地址 本机地址  ','Windows 10','Chrome(75.0.3770.100)','http://base.local/admin/sql/index.html','admin','Sql','index','GET','a:0:{}','1576218490');
